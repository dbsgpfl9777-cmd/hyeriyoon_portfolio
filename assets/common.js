    ...
    <div class="sidebar" style="width:${widthPx}px">
      <div>
        ...
        <nav class="sidebar-nav">
          <a href="#about-section" data-nav="about"><span class="bar"></span>ABOUT ME</a>
          <a href="#portfolio-section" data-nav="portfolio"><span class="bar"></span>PORTFOLIO</a>
          <a href="#experience-section" data-nav="experience"><span class="bar"></span>EXPERIENCE</a>
        </nav>
      </div>
      <div class="sidebar-links">
        <a href="${PROFILE.links.email}">
          <span class="ic ic-email"></span>Email
        </a>
        <a href="${PROFILE.links.youtube}" target="_blank" rel="noreferrer">
          <span class="ic ic-youtube"><span class="tri"></span></span>YouTube
        </a>
        <a href="${PROFILE.links.drive}" target="_blank" rel="noreferrer">
          <span class="ic ic-drive"></span>Google Drive
        </a>
        <a href="${PROFILE.links.pdf}">
          <span class="ic ic-pdf"></span>PDF / Resume
        </a>
      </div>
    </div>`;
}
...
function renderVideoBox(videoUrl, captionText) {
  ...
  return `
    <div class="video-box">
      <div class="play-btn"><div class="tri"></div></div>
      <div class="video-caption">${captionText || 'VIDEO NOT SET'}</div>
    </div>`;
}
